  ...
  return (
    <section className="relative min-h-screen pt-20 flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-slate-900/80 via-slate-950/85 to-slate-900/80 md:from-slate-900/75 md:via-slate-950/80 md:to-slate-900/75 backdrop-blur-[2px]" />
      </div>
      ...
      <div className="container-bank px-4 md:px-8 relative z-10 py-20">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl lg:text-8xl font-heading font-bold text-white text-foreground leading-[1.1] mb-8"
          >
            The Future of <br />
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-muted-foreground text-white mb-12 max-w-2xl leading-relaxed"
          >
